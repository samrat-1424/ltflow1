...
@section('subtitle', 'Create a new article for the blog')

@section('content')
<div class="card shadow-sm">
    <div class="card-body">
        <form id="blog-form" action="{{ route('admin.blogs.store') }}" method="POST" novalidate enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-3">
                ...
                @error('featured_image')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
                <div class="form-text">Recommended dimensions: at least 1200×630px for SEO social previews.</div>
            </div>
